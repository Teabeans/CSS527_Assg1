...
// PreCons: None
// PosCons: None
// RetVal:  std::string - The ciphertext rows as a string
...
} // Closing renderBinaryString()

// (+) --------------------------------|
// #renderPlaintext( int )
// ------------------------------------|
// Desc:    Renders the Sbox's plaintext buffer
// Params:  int arg1 - The amount of plaintext characters to render
// PreCons: None
// PosCons: None
// RetVal:  None
...
// (+) --------------------------------|
// #renderCiphertext( int )
// ------------------------------------|
// Desc:    Renders the Sbox's ciphertext buffer
// Params:  int arg1 - The number of characters of ciphertext to render
// PreCons: None
// PosCons: None
// RetVal:  None
